...
All three delegate to `/grc-engineer:gap-assessment` with SCF framework ID `uk-ncsc-ce-2021` for the control-by-control mechanics, and wrap the results in CE+-specific terminology.
